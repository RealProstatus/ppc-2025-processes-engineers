...
- **Функциональные тесты:**
  ...
  - Прямоугольные матрицы: 5×6·6×7 и 5×4·4×3.
...
Для больших матриц (2048×2048) эффективность при 2 процессах выше (77.65% против 71.23%), что подтверждает улучшение отношения вычислений к коммуникациям. Однако при 4 процессах разница минимальна (50.13% против 51.66%), что указывает на сохраняющееся доминирование коммуникационных затрат при большом числе процессов. Как следствие - при заданной размерности необходимо выбирать оптимальное количество процессов.
